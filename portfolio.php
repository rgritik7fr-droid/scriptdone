<?php require('./common/header.php')?>
    ...
    <!-- Start Team Section -->
    <div class="portfolio-list-section scroll-margin pt-120 mb-120" id="portfolio-grid">
        <div class="container">
            <div class="eg-card2 style-2 mb-60 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="row g-0">
                    <div class="col-lg-6">
                        <div class="card-img">
                    ...
                    <div class="col-lg-6">
                        <div class="card-content">
                            ...
                            <h5><a href="portfolio-details.html">Designing a Stylish Online Presence.</a></h5>
                            <p>There are many variations of simply free text passages of available bumo the majority have suffered alteration in some form, by injected humanjort randomised words which don't slightly.</p>
                            <ul class="tag-list">
                                <li><a href="portfolio-grid.html">Web Design</a></li>
                                <li><a href="portfolio-grid.html">Development</a></li>
                                <li><a href="portfolio-grid.html">Graphic Design</a></li>
                                <li><a href="portfolio-grid.html">Software</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            </div>
            <div class="eg-card2 style-2 mb-60 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="row g-0">
                    <div class="col-lg-6">
                        <div class="card-img">
                    ...
                    <div class="col-lg-6">
                        <div class="card-content">
                            <span>Client: Egenslab</span>
                            <h5><a href="portfolio-details.html">Visual Dynamics Creating A Striking Brand</a></h5>
                            <p>Here are several variations of the readily available free text passages, most of which have undergone some sort of modification due to the introduction of humanjort randomised words that don't quite fit in.</p>
                            <ul class="tag-list">
                                <li><a href="portfolio-grid.html">Web Design</a></li>
                                <li><a href="portfolio-grid.html">Development</a></li>
                                <li><a href="portfolio-grid.html">Graphic Design</a></li>
            ...
            <div class="eg-card2 style-2 mb-60 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div class="row g-0">
                    <div class="col-lg-6">
                        <div class="card-img">
                    ...
                    <div class="col-lg-6">
                        <div class="card-content">
                            <span>Client: Egenslab</span>
                            <h5><a href="portfolio-details.html">Tech Fusion Integrate One Solutions.</a></h5>
                            <p>The bulk of the simply free text sections that are provided have been altered in some way, usually by adding humanjort randomised words that don't change much.</p>
                            <ul class="tag-list">
                                <li><a href="portfolio-grid.html">Web Design</a></li>
                                <li><a href="portfolio-grid.html">Development</a></li>
                                <li><a href="portfolio-grid.html">Graphic Design</a></li>
            ...
            <div class="eg-card2 style-2 mb-60 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                <div class="row g-0">
                    <div class="col-lg-6">
                        <div class="card-img">
                    ...
                    <div class="col-lg-6">
                        <div class="card-content">
                            <span>Client: Egenslab</span>
                            <h5><a href="portfolio-details.html">Interctive Wonderland An Immersive Expo.</a></h5>
                            <p>A significant number of the readily available free text passages have had some sort of alteration, with the majority undergoing small modifications due to the introduction of human-curated random words.</p>
                            <ul class="tag-list">
                                <li><a href="portfolio-grid.html">Web Design</a></li>
                                <li><a href="portfolio-grid.html">Development</a></li>
                                <li><a href="portfolio-grid.html">Graphic Design</a></li>
            ...
            <div class="eg-card2 style-2 mb-60 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                <div class="row g-0">
                    ...
                    <div class="col-lg-6">
                        <div class="card-content">
                            <span>Client: Egenslab</span>
                            <h5><a href="portfolio-details.html">Code Crafed Magic Digital  Landscape.</a></h5>
                            <p>There are several versions of the readily available free text passages, most of which have been altered in some way by the addition of humanjort randomised words that don't quite fit in.</p>
                            <ul class="tag-list">
                                <li><a href="portfolio-grid.html">Web Design</a></li>
                                <li><a href="portfolio-grid.html">Development</a></li>
                                <li><a href="portfolio-grid.html">Graphic Design</a></li>
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <a href="package-grid.html" class="load-btn">
                        <span>
                            Load More
                        ...
                        <div class="contact-area wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
                            ...
                            <div class="hotline-area">
                                ...
                                <div class="content">
                                    ...
                                    <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#c9a0a7afa689acb1a8a4b9a5ace7aaa6a4"><span class="__cf_email__" data-cfemail="4b22252d240b2c262a222765282426">[email&#160;protected]</span></a></h6>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="contact-area">
                ...
                <div class="hotline-area">
                    ...
                    <div class="content">
                        <span>Say Hello</span>
                        <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#97fef9f1f8d7f2eff6fae7fbf2b9f4f8fa"><span class="__cf_email__" data-cfemail="751c1b131a35100d14180519105b161a18">[email&#160;protected]</span></a></h6>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from demo.egenslab.com/html/zenfy/preview/portfolio-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jan 2026 15:42:37 GMT -->
</html>